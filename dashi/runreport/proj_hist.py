...
layout = html.Div(
    [
        ...
        dcc.Dropdown(id="focused_run", clearable=False),
        # dcc.Graph(
        #     id='coverage_hist'
        # ),
        dcc.Graph(id="coverage_dist"),
...
@app.callback(Output("focused_run", "value"), [Input("project", "value")])
...
@app.callback(
    Output("click-data", "children"), [Input("coverage_dist", "clickData")]
)
