...
layout = html.Div(
    children=[
        ...
        sd.RaisedButton(id="filters", label="Filters"),
        html.Div(
            children=[
                ...
                html.Div(
                    [
                        sd.Paper(dcc.Graph(id="SampleIndices")),
                        sd.Paper(dcc.Graph(id="Per Cent Difference")),
                    ],
...
@app.callback(
    dep.Output("lane_select", "options"), [dep.Input("select_a_run", "value")]
)
...
@app.callback(
    dep.Output("lane_select", "value"), [dep.Input("lane_select", "options")]
)
...
@app.callback(
    ...
    [dep.Input("lane_select", "value"), dep.Input("select_a_run", "value")],
)
...
@app.callback(
    dep.Output("Filter_drawer", "open"), [dep.Input("filters", "n_clicks")]
)
...
@app.callback(
    ...
    [dep.Input("select_a_run", "value"), dep.Input("lane_select", "value")],
)
