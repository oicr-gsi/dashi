...
| `ENABLED_REPORTS`       | No        | Comma-separated list of view module page_names to enable on this deployment                                                                              | `call_ready_wgs,single_lane_wgs,bcl2barcode`          | all reports         |
| `REPORT_SOURCES`        | **Yes**   | Comma-separated list of absolute paths to directories containing view modules                                                                            | `/home/ubuntu/workspace/dashi/oicr-reports`             |                                                                            
