...
| `ENABLED_REPORTS`           | No                     | Comma-separated list of view module names (as listed in `ALL_PAGENAMES` in `pages.py`) to enable on this deployment                                       | `call_ready_wgs,single_lane_wgs,bcl2barcode`           | all reports |
