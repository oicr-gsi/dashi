...
def generateUnmappedReads(current_data, colourby, shapeby, shownames):
    return generate(
        ...
        current_data,
        lambda d: d[PINERY_COL.SampleName],
        lambda d: slider_utils.percentageOf(d, BAMQC_COL.UnmappedReads),
        "%",
        colourby,
        shapeby,
        shownames
...
def generateNonprimaryReads(current_data, colourby, shapeby, shownames):
    return generate(
        ...
        current_data,
        lambda d: d[PINERY_COL.SampleName],
        lambda d: slider_utils.percentageOf(d, BAMQC_COL.NonPrimaryReads),
        "%",
        colourby,
        shapeby,
        shownames
...
def generateOnTargetReads(current_data, colourby, shapeby, shownames):
    return generate(
        ...
        current_data,
        lambda d: d[PINERY_COL.SampleName],
        lambda d: slider_utils.percentageOf(d, BAMQC_COL.ReadsOnTarget),
        "%",
        colourby,
        shapeby,
        shownames
...
def generateReadsPerStartPoint(current_data, colourby, shapeby, shownames,
    ...
    return generate(
        ...
        current_data,
        lambda d: d[PINERY_COL.SampleName],
        lambda d: slider_utils.percentageOf(d, BAMQC_COL.ReadsPerStartPoint),
        "Fraction",
        colourby,
        shapeby,
        shownames,
