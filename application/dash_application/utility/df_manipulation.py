...
concat_columns_for_merge = {
    # @merged_library columns are already included in the index
    # sample attributes
...
_pinery_merged_samples = _pinery_samples.fillna('').groupby(by=pinery_merged_columns).agg(concat_columns_for_merge).reset_index()
